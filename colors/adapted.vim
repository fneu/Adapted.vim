...
"}}}
" {{{ Colors
  let s:base00=['#263238', '235']
  let s:base01=['#37474f', '237']
  let s:base02=['#455a64', '240']
  let s:base03=['#546e7a', '243']
  let s:base04=['#90a4ae', '145']
  let s:base05=['#b0bec5', '251']
  let s:base06=['#cfd8dc', '252']
  let s:base07=['#eceff1', '253']
  let s:base08=['#e57373', '203']
  let s:base09=['#ffb74d', '209']
  let s:base0A=['#fff176', '221']
  let s:base0B=['#81c784', '114']
  let s:base0C=['#4db6ac', '73']
  let s:base0D=['#64b5f6', '68']
  let s:base0E=['#ba68c8', '176']
  let s:base0F=['#a1887f', '137']
