...
" {{{ Colors
  ...
  let s:base08=['#f44336', '124']
  let s:base09=['#ff9800', '131']
  let s:base0A=['#ffeb58', '137']
  let s:base0B=['#4caf50', '101']
  let s:base0C=['#009688', '72']
  let s:base0D=['#2196f3', '60']
  let s:base0E=['#9c27b0', '96']
  let s:base0F=['#795548', '101']
